...
export const DOSEA_DOSING_RULES_V2_VALIDATED = [
  ...
  },
  {
    ...
    "dose_expression": {
      "raw_current_posology": "2,4 mg/kg IV/IM à H0, H12, H24, puis q24h. Minimum 24h de traitement IV avant relais PO par ACT. Artésunate rectal 10 mg/kg si accès IV impossible. (Source: MSF)",
      "validated_posology_text": "encoder comme règle conditionnelle/source-dépendante : 2,4 mg/kg IV/IM à H0, H12, H24, puis q24h. Minimum 24h de traitement IV avant relais PO par ACT. Artésunate rectal 10 mg/kg si accès IV impossible.\nParamètres retenus pour encodage, sous réserve de conformité source : dose app actuelle=2.4 mg/kg ; max/prise=120 mg ; fréquence/j=1 ; intervalle min=12 h.",
      "structured_parameters_from_review_table": {
